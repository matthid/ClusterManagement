...
# docker build --squash . -t matthid/clustermanagement:latest -t matthid/clustermanagement:0.2.2 && docker push matthid/clustermanagement:0.2.2 && docker push matthid/clustermanagement:latest
