...
# docker build --squash . -t matthid/clustermanagement:latest -t matthid/clustermanagement:0.2.0 && docker push matthid/clustermanagement:0.2.0 && docker push matthid/clustermanagement:latest
