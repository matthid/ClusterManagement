...
# docker build --squash . -t matthid/clustermanagement:latest -t matthid/clustermanagement:0.3.4 && docker push matthid/clustermanagement:0.3.4 && docker push matthid/clustermanagement:latest
