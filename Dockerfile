...
# docker build --squash . -t matthid/clustermanagement:latest -t matthid/clustermanagement:0.3.1 && docker push matthid/clustermanagement:0.3.1 && docker push matthid/clustermanagement:latest
